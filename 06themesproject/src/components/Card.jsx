...
export default function Card() {
  return (
    <div className="w-full bg-green-500 border border-red-500 rounded-lg shadow dark:bg-blue-800 dark:border-gray-700">
      <a href="/">
        <img
      ...
      <div className="px-5 pb-5">
        ...
        <div className="flex items-center mt-2.5 mb-5">
          ...
          <svg
            className="w-4 h-4 text-gray-200 dark:text-green-600"
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            viewBox="0 0 22 20"
        ...
        <div className="flex items-center justify-between">
          <span className="text-3xl font-bold text-r-900 dark:text-white">
            $599
          </span>
          <a
            href="/"
